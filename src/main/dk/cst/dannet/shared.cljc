...
(def synset-rel-theme
  ...
  {:dns/crossPoSHypernym   "#a55194",
   :dns/crossPoSHyponym    "#e377c2",
   :dns/eqHypernym         "#8c564b",
   :dns/eqHyponym          "#9edae5",
   :dns/eqSimilar          "#fdd0a2",
   :dns/nearAntonym        "#d6616b",
   :dns/orthogonalHypernym "#387111",
   :dns/orthogonalHyponym  "#666",
   :dns/usedFor            "#a1d99b",
   :dns/usedForObject      "#3182bd",
   :wn/agent               "#e7cb94",
   :wn/also                "#9467bd",
   :wn/antonym             "#2ca02c",
   :wn/attribute           "#c6dbef",
   :wn/causes              "#ffbb78",
   :wn/co_agent_instrument "#9c9ede",
   :wn/co_instrument_agent "#393b79",
   :wn/domain_region       "#ce6dbd",
   :wn/domain_topic        "#019fa1",
   :wn/entails             "#c5b0d5",
   :wn/eq_synonym          "#de9ed6",
   :wn/exemplifies         "#fdae6b",
   :wn/has_domain_region   "#ff9896",
   :wn/has_domain_topic    "#df7300",
   :wn/holo_location       "#cedb9c",
   :wn/holo_member         "#e7969c",
   :wn/holo_part           "#7b4173",
   :wn/holo_substance      "#aec7e8",
   :wn/holonym             "#74c476",
   :wn/hypernym            "#901a1e",
   :wn/hyponym             "#55f",
   :wn/instance_hypernym   "#bcbd22",
   :wn/instance_hyponym    "#c49c94",
   :wn/involved_agent      "#8c6d31",
   :wn/involved_patient    "#9ecae1",
   :wn/involved_result     "#1f77b4",
   :wn/is_caused_by        "#31a354",
   :wn/is_entailed_by      "#b5cf6b",
   :wn/is_exemplified_by   "#5254a3",
   :wn/mero_location       "#e7ba52",
   :wn/mero_member         "#c7c7c7",
   :wn/mero_part           "#637939",
   :wn/mero_substance      "#6baed6",
   :wn/meronym             "#8ca252",
   :wn/other               "#bd9e39",
   :wn/patient             "#f7b6d2",
   :wn/result              "#98df8a",
