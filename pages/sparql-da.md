...
> **BEMÆRK:** et komplet overblik over de anvendte synset-relationer (grupperet efter type og med beskrivelser) findes på siden med [synset-relationer](/dannet/relations). Vælger man "Minimal" i menuen på den side, vises relationernes tekniske navne, dvs. dem der bruges i SPARQL-forespørgsler.
